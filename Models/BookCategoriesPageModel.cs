...
namespace Blegu_Larisa_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Blegu_Larisa_lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Blegu_Larisa_lab2Context context,
